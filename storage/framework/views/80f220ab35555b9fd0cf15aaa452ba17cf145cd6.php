                    ...
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            ...
                            <div class="nk-block-des text-soft">
                                <p>You have total <?php echo e(count($users)); ?> users.</p>
                            </div>
                        </div>
                        <div class="nk-block-head-content">
                                ...
                                <div class="card-search search-wrap" data-search="search">
                                    <div class="card-body">
                                        <div class="search-content">
                                            ...
                                            <form action="<?php echo e(route('searchUser')); ?>" method="POST" id="search_form_id">
                            ...
                            <div class="card-inner p-0">
                                <div class="nk-tb-list nk-tb-ulist">
                                    ...
                                    <div class="nk-tb-item">
                                        <div class="nk-tb-col nk-tb-col-check">
                                            <div class="custom-control custom-control-sm custom-checkbox notext">
                                                <input type="checkbox" class="custom-control-input" id="uid<?php echo e($user->id); ?>" name="mailusers[]" value='<?php echo e($user->id); ?>'>
                                                <label class="custom-control-label" for="uid<?php echo e($user->id); ?>"></label>
                                            </div>
                                        </div>
                                        <div class="nk-tb-col">
                                            <div class="user-card">
                                                <div class="user-avatar bg-info"><span><?php echo e(strtoupper($user->name[0])); ?><?php echo e(strtoupper($user->l_name[0])); ?></span></div>
                                                <div class="user-info"><span class="tb-lead"><?php echo e($user->name); ?> <?php echo e($user->l_name); ?>

                                                        <span class="dot dot-success d-md-none ml-1"></span></span><span><?php echo e($user->email); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="nk-tb-col tb-col-mb"><span class="tb-amount"><?php echo e($user->account_bal); ?>

                                                <span class="currency"><?php echo e($settings->s_currency); ?></span></span></div>
                                        <div class="nk-tb-col tb-col-md"><span><?php echo e($user->phone_number); ?></span></div>
                                        ...
                                        <div class="nk-tb-col tb-col-md">
                                            <?php if($user->status=="active"): ?>
                                            <span class="tb-status text-success"><?php echo e(strtoupper($user->status)); ?></span>

                                            <?php elseif($user->status=="suspend"): ?>
                                            <span class="tb-status text-warning"><?php echo e(strtoupper($user->status)); ?></span>

                                            <?php else: ?>
                                            <span class="tb-status text-danger"><?php echo e(strtoupper($user->status)); ?></span>
                                        ...
                                        <div class="nk-tb-col nk-tb-col-tools">
                                            <ul class="nk-tb-actions gx-1">
                                                <li class="nk-tb-action-hidden"><a href="" data-toggle="modal" id="showUser" data-target="#manage_user" data-id="<?php echo e($user->id); ?>" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Quick View"><em class="icon ni ni-focus"></em></a></li>
                                                <li class="nk-tb-action-hidden"><a href="" data-toggle="modal" id="editUser" data-target="#manage_user" data-id="<?php echo e($user->id); ?>" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Edit"><em class="icon ni ni-edit-fill"></em></a></li>
                                                <li class="nk-tb-action-hidden"><a href="" data-toggle="modal" id="showMailForm" data-target="#sendmailModal" data-id="<?php echo e($user->id); ?>" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Send Email"><em class="icon ni ni-mail-fill"></em></a></li>
                                                <li>
                                                    <div class="drodown"><a href="#" class="dropdown-toggle btn btn-icon btn-trigger" data-toggle="dropdown"><em class="icon ni ni-more-h"></em></a>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a href="" data-toggle="modal" id="showUser" data-target="#manage_user" data-id="<?php echo e($user->id); ?>"><em class="icon ni ni-focus"></em><span>Quick
                                                                            View</span></a></li>
                                                                <li><a href="<?php echo e(route('user_details',$user->id)); ?>"><em class="icon ni ni-eye"></em><span>View
                                                                            Profile</span></a></li>
                                                                <li><a href="" data-toggle="modal" id="editUser" data-target="#manage_user" data-id="<?php echo e($user->id); ?>"><em class="icon ni ni-edit"></em><span>Edit
                                                                            Profile</span></a></li>

                                                                <li><a href="" data-toggle="modal" id="showMailForm" data-target="#sendmailModal" data-id="<?php echo e($user->id); ?>"><em class="icon ni ni-mail-fill"></em><span>Send Email
                                                                        </span></a></li>

                                                                <li class="divider"></li>
                                                                <li><a href="" data-toggle="modal" id="showCreditForm" data-target="#transactionmodal" data-id="<?php echo e($user->id); ?>"><em class="icon ni ni-wallet-in"></em><span>Credit Account</span></a>
                                                                </li>
                                                                <li><a href="" data-toggle="modal" id="showDebitForm" data-target="#transactionmodal" data-id="<?php echo e($user->id); ?>"><em class="icon ni ni-wallet-out"></em><span>Debit Account</span></a>
                                                                </li>
                                                                <li><a href="<?php echo e(route('user_details',$user->id)); ?>"><em class="icon ni ni-tranx"></em><span>Transaction</span></a>
                                                                </li>
                                                                <li><a href="<?php echo e(route('user_details',$user->id)); ?>"><em class="icon ni ni-activity-round"></em><span>Activities</span></a>
                                                                </li>
                                                                <li class="divider"></li>
                                                                <li><a href="<?php echo e(route('resetpassword',$user->id)); ?>"><em class="icon ni ni-lock"></em><span>Reset
                                                                            Pass</span></a></li>
                                                                <li><a href="<?php echo e(route('reset2fa',$user->id)); ?>"><em class="icon ni ni-security"></em><span>Reset
                                                                            2FA</span></a></li>
                                                                <?php if($user->status!="suspend" && $user->status!="blocked" && $user->status!=null): ?>
                                                                <li><a href="<?php echo e(url('dashboard/ublock')); ?>/<?php echo e($user->id); ?>"><em class="icon ni ni-na"></em><span>Suspend
                                                                            User</span></a></li>

                                                                <?php elseif($user->status=="suspend" && $user->status!=null): ?>
                                                                <li><a href="<?php echo e(url('dashboard/unblock')); ?>/<?php echo e($user->id); ?>"><em class="icon ni ni-check-thick"></em><span>Unsuspend
                                                                            User</span></a></li>
                                                                <?php endif; ?>

                                                                <li>
                                                                    <a href="<?php echo e(url('dashboard/deluser')); ?>/<?php echo e($user->id); ?>"><em class="icon ni ni-user-cross-fill"></em><span>Delete User</span>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </div>
