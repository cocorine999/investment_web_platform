...
<?php $__env->startSection("content"); ?>
    ...
    <section id="home" class="hero-section">
        <div class="hero__slider owl-carousel">
            <div class="hero__item set-bg" data-setbg="<?php echo e(asset('assets/img/hero/hero-1.jpg')); ?>">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <h5>Find out how to invest <br/> in the projects selected by BillionCycle.</h5>
                                ...
                                <a href="<?php echo e(route('register')); ?>" class="primary-btn">Get started now</a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="hero__img">
                                <img src="<?php echo e(asset('assets/img/hero/hero-right.png')); ?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="feature__item" style="padding: 0px 0px 3px 0px!important;">
                        <div class="blog__item">
                                <div class="blog__pic set-bg" style="height: 240px;" data-setbg="<?php echo e(asset('assets/img/services/agro.jpg')); ?>" style="background-image: url(<?php echo e(asset('assets/img/services/agro.jpg')); ?>);">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="feature__item" style="padding: 0px 0px 3px 0px!important;">
                        <div class="blog__item">
                                <div class="blog__pic set-bg" style="height: 240px;" data-setbg="<?php echo e(asset('assets/img/services/immo.jpg')); ?>" style="background-image: url(&quot;img/blog/blog-8.jpg&quot;);">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="feature__item" style="padding: 0px 0px 3px 0px!important;">
                        <div class="blog__item">
                                <div class="blog__pic set-bg" style="height: 240px;" data-setbg="<?php echo e(asset('assets/img/services/renouvelable.jpg')); ?>" style="background-image: url(&quot;img/blog/blog-8.jpg&quot;);">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="feature__item" style="padding: 0px 0px 3px 0px!important;">
                        <div class="blog__item">
                                <div class="blog__pic set-bg" style="height: 240px;" data-setbg="<?php echo e(asset('assets/img/services/automobile.jpg')); ?>" style="background-image: url(&quot;img/blog/blog-8.jpg&quot;);">

                                    <img src="<?php echo e(asset('assets/img/services/automobile.jpg')); ?>" alt="">
    ...
    <section id="pricing" class="pricing-section spad">
        <div class="container">
                    ...
                    <?php if($plan->price < 500): ?>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="pricing__item">
                                ...
                                <h3><?php echo e($settings->currency); ?><?php echo e($plan->price); ?></span></h3>
                                <ul>

                                    <li><span class="desc-label">Daily Interest (%) </span> - <span
                                                                        class="desc-data"><?php echo e(round($plan->increment_amount,2)); ?>%</span></li>
                                    <li><span class="desc-label">Daily Interest</span> - <span
                                                                        class="desc-data">$<?php echo e(round($plan->increment_amount,2)); ?></span></li>
                                                                ...
                                                                <li><span class="desc-label">Terms Days</span> - <span
                                                                        class="desc-data"><?php echo e($plan->expiration); ?></span></li>
                                </ul>
                                <a href="<?php echo e(route('register')); ?>" class="primary-btn">Choose plan</a>
                            </div>
                        </div>
                    <?php endif; ?>
            ...
            <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <!-- Basic Plan  -->
                    <?php if($plan->price >=500 && $plan->price < 3000): ?>
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="pricing__item">
                                <h4><?php echo e($plan->name); ?></h4>
                                <h3><?php echo e($settings->currency); ?><?php echo e($plan->price); ?></span></h3>
    ...
    <section class="achievement-section set-bg spad" data-setbg="<?php echo e(asset('assets/img/achievement-bg.jpg')); ?>">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <img src="<?php echo e(asset('assets/img/home-illustration/cryptocurrency-market-3216964-2738779.png')); ?>" alt="">
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="plan__text">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="primary-btn">Get start now</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="testimonial__slider owl-carousel">
                    <div class="col-lg-4">
                        <div class="testimonial__item" style="height:320px!important;">
                            <img src="<?php echo e(asset('assets/img/testimonial/testimonial-1.jpg')); ?>" alt="">
                            <h5>Macrina Kgril</h5>
                            <span></span>
                    ...
                    <div class="col-lg-4">
                        <div class="testimonial__item"  style="height:320px!important;">
                            <img src="<?php echo e(asset('assets/img/testimonial/alphonse.jpg')); ?>" alt="" style="width:120px!important; height:120px!important;" >
                    ...
                    <div class="col-lg-4">
                        <div class="testimonial__item" style="height:320px!important;">
                            <img src="<?php echo e(asset('assets/img/testimonial/testimonial-3.jpg')); ?>" alt="">
                            <h5>Alessia Haas</h5>
                            <span></span>
                    ...
                    <div class="col-lg-4">
                        <div class="testimonial__item" style="height:320px!important;">
                            <img src="<?php echo e(asset('assets/img/testimonial/antony.jpg')); ?>" alt="" style="width:120px!important; height:120px!important;">
                            ...
                            <div class="card">
                                <div class="card-heading active">
                                    <a class="active" data-toggle="collapse" data-target="#collapseOne">
                                        What is <?php echo e($settings->site_name); ?>?
                                    </a>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-heading">
                                    <a data-toggle="collapse" data-target="#collapseTwo">
                                        How <?php echo e($settings->site_name); ?> works?
                                    </a>
                                </div>
...
<?php echo $__env->make("home.app", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>