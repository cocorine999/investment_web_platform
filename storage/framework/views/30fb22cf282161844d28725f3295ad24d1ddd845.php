                                ...
                                <div class="nk-block-between">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des text-soft">
                                            <p>Welcome <?php echo e(Auth::user()->name); ?> <?php echo e(Auth::user()->l_name); ?>.</p>
                                        </div>
                                    </div>
                                    <div class="nk-block-head-content">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card card-bordered card-full">
                                            <div class="card-inner">
                                                ...
                                                <div class="card-amount"><span class="amount">  <?php echo e(number_format($total_invested,2,'.',',')); ?>  <span
                                                ...
                                                <div class="invest-data">
                                                    <div class="invest-data-amount g-2">
                                                        <div class="invest-data-history">
                                                            ...
                                                            <div class="amount"> <?php echo e(number_format($musp,2,'.',',')); ?> <span
                                                                    class="currency currency-usd">USD</span></div>
                                                        </div>
                                                        <div class="invest-data-history">
                                                            <div class="title">This Week</div>
                                                            <div class="amount"> <?php echo e(number_format($wusp,2,'.',',')); ?> <span
                                                                    class="currency currency-usd">USD</span></div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card card-bordered card-full">
                                            <div class="card-inner">
                                                ...
                                                <div class="card-amount"><span class="amount">  <?php echo e(number_format($deposited,2,'.',',')); ?>  <span
                                                            class="currency currency-usd">USD</span></span><!-- <span
                                                ...
                                                <div class="invest-data">
                                                    <div class="invest-data-amount g-2">
                                                        <div class="invest-data-history">
                                                            <div class="title">This Month</div>
                                                            <div class="amount"> <?php echo e(number_format($mdp,2,'.',',')); ?> <span
                                                                    class="currency currency-usd">USD</span></div>
                                                        </div>
                                                        <div class="invest-data-history">
                                                            <div class="title">This Week</div>
                                                            <div class="amount"> <?php echo e(number_format($wdp,2,'.',',')); ?>  <span
                                                                    class="currency currency-usd">USD</span></div>
                                                        </div>
                                                    </div>
                                                    <div class="invest-data-ck"><canvas class="iv-data-chart"
                                    ...
                                    <div class="col-md-4">
                                        <div class="card card-bordered card-full">
                                            <div class="card-inner">
                                                ...
                                                <div class="card-amount"><span class="amount">  <?php echo e(number_format($total_withdrawals,2,'.',',')); ?>  <span
                                                            class="currency currency-usd">USD</span></span><!-- <span
                                                        class="change down text-danger"><em
                                                            class="icon ni ni-arrow-long-down"></em>1.93%</span> --></div>
                                                <div class="invest-data">
                                                    <div class="invest-data-amount g-2">
                                                        <div class="invest-data-history">
                                                            <div class="title">This Month</div>
                                                            <div class="amount"> <?php echo e(number_format($mwd,2,'.',',')); ?>  <span
                                                                    class="currency currency-usd">USD</span></div>
                                                        </div>
                                                        <div class="invest-data-history">
                                                            <div class="title">This Week</div>
                                                            <div class="amount"> <?php echo e(number_format($wwd,2,'.',',')); ?> <span
                                                                    class="currency currency-usd">USD</span></div>
                                                        </div>
                                                    </div>
                                                    <div class="invest-data-ck"><canvas class="iv-data-chart"
                                            ...
                                            <ul class="nk-activity">
                                                <li class="nk-activity-item">
                                                    <div class="nk-activity-media user-avatar bg-success"><img
                                                            src="<?php echo e(asset('billion/images/c-sm.jpg')); ?>" alt=""></div>
                                                ...
                                                <li class="nk-activity-item">
                                                    <div class="nk-activity-media user-avatar bg-purple"><img
                                                            src="<?php echo e(asset('billion/images/d-sm.jpg')); ?>" alt=""></div>
                                                    <div class="nk-activity-data">
                                        ...
                                        <div class="card card-bordered card-full">
                                            <div class="card-inner border-bottom">
                                                <div class="card-title-group">
                                                    ...
                                                    <div class="card-tools"><a href="<?php echo e(route('myplans')); ?>" class="link">View All</a></div>
                                                </div>
                                            </div>
                                            <div class="nk-tb-list">
                                                ...
                                                <?php $__currentLoopData = $new_investment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="nk-tb-item">
                                                        <div class="nk-tb-col">
                                                            <div class="align-center">
                                                                <div class="user-avatar user-avatar-sm bg-light">
                                                                    <span>P<?php echo e($invest->dplan->id); ?></span></div><span class="tb-sub ml-2"> <?php echo e($invest->dplan->name); ?>
                                                        ...
                                                        <div class="nk-tb-col tb-col-sm">
                                                            <div class="user-card">
                                                                <div class="user-avatar user-avatar-xs bg-teal-dim">
                                                                    <span><?php echo e($invest->userplan->l_name['0']); ?><?php echo e($invest->userplan->name['0']); ?></span></div>
                                                        ...
                                                        <div class="nk-tb-col tb-col-lg"><span
                                                                class="tb-sub"><?php echo e($invest->activated_at->format('d/m/Y')); ?></span></div>
                                                        <div class="nk-tb-col"><span class="tb-sub tb-amount"><?php echo e(number_format($invest->amount,2,'.',',')); ?>

                                                                <span>USD</span></span></div>
                                                        <div class="nk-tb-col"><span class="tb-sub tb-amount"><?php echo e($invest->amount); ?>

                                                                <span>USD</span></span></div>
                                                        <div class="nk-tb-col tb-col-sm"><span
                                                                class="tb-sub text-success"><?php echo e($invest->status); ?></span></div>
...
<script src="<?php echo e(asset('billion/js/charts/gd-invest.js?ver=2.5.0')); ?>"></script>
<?php $__env->stopPush(); ?>
