                                            ...
                                            <div class="card">
                                                <div id="faqs" class="accordion">
                                                    <div class="accordion-item"><a href="#" class="accordion-head"
                                                            data-toggle="collapse" data-target="#faq-q1">
                                                    ...
                                                    <div class="accordion-item"><a href="#"
                                                            class="accordion-head collapsed" data-toggle="collapse"
                                                            data-target="#faq-q2">
                                                            <h6 class="title">Do I need a Regular License or an Extended
                                                                License?</h6><span class="accordion-icon"></span>
                                                        </a>
                                                            ...
                                                            <div class="accordion-inner">
                                                                ...
                                                                <p>You may charge your client for your services to
                                                                    ...
                                                                    <strong>Regular License</strong>. <strong>But you
                                                                        ...
                                                                        multiple clients or jobs.</strong></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="accordion-item"><a href="#"
                                                            class="accordion-head collapsed" data-toggle="collapse"
                                                            data-target="#faq-q3">
                                                            <h6 class="title">What is Item Support?</h6><span
                                                                class="accordion-icon"></span>
                                                        </a>
                                                    ...
                                                    <div class="accordion-item"><a href="#"
                                                            class="accordion-head collapsed" data-toggle="collapse"
                                                            data-target="#faq-q4">
                                                            <h6 class="title">How to download your Item</h6><span
                                                                class="accordion-icon"></span>
                                                        </a>
                                                    ...
                                                    <div class="accordion-item"><a href="#"
                                                            class="accordion-head collapsed" data-toggle="collapse"
                                                            data-target="#faq-q5">
                                                            <h6 class="title">How to contact before purchase?</h6><span
                                                                class="accordion-icon"></span>
                                                        </a>
                                            ...
                                            <div class="card card-bordered">
                                                <div class="card-inner">
                                                    <div class="align-center flex-wrap g-4 text-center">
                                                        <div class="nk-block-image w-120px flex-shrink-0 mx-auto"><svg
                                                        ...
                                                        <div class="nk-block-content flex-shrink-0 mt-lg-4 mx-auto"><a
                                                                href="#" class="btn btn-lg btn-outline-primary">Get
                                                                Support Now</a></div>
                                                    </div>
                                                </div>
                                            </div>
