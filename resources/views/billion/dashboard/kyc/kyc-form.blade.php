                ...
                <div class="kyc-app wide-sm m-auto">
                    ...
                    <div class="nk-block">
                        <div class="card card-bordered">
                            ...
                            <form method="POST" action="{{route('savevdocs')}}" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="nk-kycfm">
                                    ...
                                    <div class="nk-kycfm-content">
                                        <div class="nk-kycfm-note"><em class="icon ni ni-info-fill" data-toggle="tooltip" data-placement="right" title="Tooltip on right"></em>
                                        ...
                                        <div class="row g-4">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-group"><input readonly="readonly" type="text" value="{{Auth::user()->name}}" class="form-control form-control-lg"></div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="form-label-group"><label class="form-label">Last
                                                            Name <span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="form-control-group"><input readonly="readonly" type="text" value="{{Auth::user()->l_name}}" class="form-control form-control-lg"></div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="form-label-group"><label class="form-label">Email Address <span class="text-danger">*</span></label></div>
                                                    <div class="form-control-group"><input readonly="readonly" type="text" value="{{Auth::user()->email}}" class="form-control form-control-lg"></div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="form-label-group"><label class="form-label">Phone Number <span class="text-danger">*</span></label></div>
                                                    <div class="form-control-group"><input readonly="readonly" type="text" value="{{Auth::user()->phone_number}}" class="form-control form-control-lg"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-kycfm-head">
                                        ...
                                        <div class="nk-kycfm-title">
                                            ...
                                            <p class="sub-title">To verify your identity, please upload the list of
                                                this documents.</p>
                                        </div>
                                    </div>
                                    <div class="nk-kycfm-content">
                                        <div class="nk-kycfm-note"><em class="icon ni ni-info-fill" data-toggle="tooltip" data-placement="right" title="Tooltip on right"></em>
                                            <p>In order to complete, please upload list of the following personal
                                                document.</p>
                                        </div>
                                        <ul class="nk-kycfm-control-list g-3">
                                            <li class="nk-kycfm-control-item"><input class="nk-kycfm-control" type="radio" name="n-passport" id="passport" data-title="Passport" checked><label class="nk-kycfm-label" for="passport"><span class="nk-kycfm-label-icon"><span class="label-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 71.9904 75.9285">
                                                            ...
                                                            </svg></span></span><span class="nk-kycfm-label-text">Passport</span></label></li>
                                            <li class="nk-kycfm-control-item"><input class="nk-kycfm-control" type="radio" checked name="n-id" id="national-id" data-title="National ID"><label class="nk-kycfm-label" for="national-id"><span class="nk-kycfm-label-icon"><span class="label-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 76 63">
                                                            ...
                                                            </svg></span></span><span class="nk-kycfm-label-text">National ID</span></label>
                                            </li>

                                            <li class="nk-kycfm-control-item">
                                                <input class="nk-kycfm-control" type="radio" checked name="n-birth_certificate" id="birth_certificate" data-title="Driving License">
                                                <label class="nk-kycfm-label" for="driver-licence">
                                                    ...
                                                    <span class="nk-kycfm-label-text">Birth Certificate</span>
                                                </label>
                                            </li>
                                        </ul>
                                        <h6 class="title">To avoid delays when verifying account, Please make
                                            sure bellow:</h6>
                                        ...
                                        <div class="nk-kycfm-upload">
                                            <h6 class="title nk-kycfm-upload-title">Upload Here Your National ID C</h6>
                                            <div class="form-group" style="margin-top:0.75rem;">
                                                <div class="form-control-wrap">
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="id" name="id" value="{{old('id')}}" require>
                                        ...
                                        <div class="nk-kycfm-upload">
                                            <h6 class="title nk-kycfm-upload-title">Upload Here Your Passport Copy</h6>
                                            <div class="form-group" style="margin-top:0.75rem;">
                                                <div class="form-control-wrap">
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="passport" name="passport" value="{{old('passport')}}" require>
                                                        <label class="custom-file-label" for="customFile">Choose file</label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="nk-kycfm-upload">
                                            <h6 class="title nk-kycfm-upload-title">Upload Here Your Birth Certificate Copy</h6>
                                            <div class="form-group" style="margin-top:0.75rem;">
                                                <div class="form-control-wrap">
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="birth_certificate" name="birth_certificate" value="{{old('birth_certificate')}}" require>
                                                        <label class="custom-file-label" for="customFile">Choose file</label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="nk-kycfm-footer">
                                        <div class="form-group">
                                            <div class="custom-control custom-control-xs custom-checkbox"><input type="checkbox" class="custom-control-input" id="tc-agree"><label class="custom-control-label" for="tc-agree">I Have Read The Terms Of
                                                        Condition And Privacy Policy</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="custom-control custom-control-xs custom-checkbox"><input type="checkbox" class="custom-control-input" id="info-assure"><label class="custom-control-label" for="info-assure">All The Personal Information I Have
