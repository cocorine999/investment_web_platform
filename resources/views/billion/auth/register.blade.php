...
<head>
    ...
    <link rel="stylesheet" href="{{asset('billion/css/dashlite.css')}}">
    <link id="skin-default" rel="stylesheet" href="{{asset('billion/css/theme.css')}}">
                    ...
                    @endif
                        ...
                        <div class="card card-bordered">
                            <div class="card-inner card-inner-lg">
                                ...
                                <form class="form" method="POST" action="{{ route('register_refer') }}">
                                    {{csrf_field()}}
                                    @if($referer)
   ...
   <option value="Zimbabwe">Zimbabwe</option>
                                    ...
                                    <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input type="password" class="form-control form-control-lg" id="password" placeholder="Re-enter your password" name="password_confirmation" value="{{ old('password_confirmation') }}" required>
    ...
    <script src="{{asset('billion/js/bundles.js?ver=2.5.0')}}"></script>
    <script src="{{asset('billion/js/scripts.js?ver=2.5.0')}}"></script>
    <script src="{{asset('billion/js/demo-settings.js?ver=2.5.0')}}"></script>
</body>
