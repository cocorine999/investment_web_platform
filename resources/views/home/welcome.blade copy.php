...
<body>
                ...
                <div class="col-lg-8">
                    <div class="register__text">
                        ...
                        <div style="text-align:center;">
                            <h3>The World's Most Popular Way to invest your crypto monnaies.</h3>
                            <br />
                            <p>Trusted by 72M Wallets - with Over $620 Billion in Transactions - Since 2013
                            </p>
                        </div>
                        <br />
                        ...
                        <div class="row">
                            <div class="col-lg-6" style="padding-bottom:100px;">
                                <div class="work__item">
                                    ...
                                    <span style="text-transform: uppercase;">Create an account</span>
                                    <h3 style="text-transform: uppercase;"> cryptocurrency account</h3>
                                    <p>Create your cryptocurrency wallet today. Lorem ipsum dolor sit amet, consectetur
                            ...
                            <div class="col-lg-6" style="padding-bottom:100px;">
                                <div class="work__item">
                                    <i class="fa fa-desktop"></i>
                                    <span style="text-transform: uppercase;">Link your bank account</span>
                                    <h3 style="text-transform: uppercase;">MANAGE YOUR account</h3>
                                    <p>Create your cryptocurrency wallet today. Lorem ipsum dolor sit amet, consectetur
                                        adipiscing elit, sed do eiusmod tempor
                                        incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices
                                        gravida facilisis. </p>
                            ...
                            <div class="col-lg-6" style="padding-bottom:10px;">
                                <div class="work__item">
                                    ...
                                    <span style="text-transform: uppercase;">Start buying and selling</span>
                                    <h3>INVEST YOUR CRYPTOCURRENCY</h3>
                            ...
                            <div class="col-lg-6" style="padding-bottom:10px;">
                                <div class="work__item">
                                    <i class="fa fa-shopping-bag"></i>
                                    <span style="text-transform: uppercase;">EARN UP TO 200% PROFIT</span>
                                    <h3 style="text-transform: uppercase;">withdraw your benefit</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices
                                        gravida facilisis. </p>
                                    <a href="#" class="primary-btn">Read More</a>
    ...
    <section class="choose-plan-section spad">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="plan__text">
                        <h3>Easy way to gain money!</h3>
                        <ul>
                            <li><span class="fa fa-check"></span> Create Your account</li>
                            <li><span class="fa fa-check"></span> Manage Your account</li>
                            <li><span class="fa fa-check"></span> Connect Your Wallets</li>
                            <li><span class="fa fa-check"></span> Invest With Confidence</li>
                            <li><span class="fa fa-check"></span> Control Your Funds from Anywhere in the World</li>
                            <li><span class="fa fa-check"></span> Earn Up To 200% Interest</li>
                            <li><span class="fa fa-check"></span>Onboard Quickly</li>
                        </ul>
    ...
    <!-- Publicité Section Begin 
    <section class="services-section spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h3>All your digital assets in one place</h3>
                    </div>
                </div>
            </div>
            <div class="row align-items-center">
                ...
                <div class="assets-wrapper ">
                    ...
                    <ul class="assets-list" style="padding: 0; list-style-type: none;">
                        <li></li>
                        <li></li>
                        <li></li>
                        
                        <li>
                            <div><img style="width: 96px" src="{{asset('home/images/btc.png')}}"
                        ...
                        <li>
                            <div><img style="width: 96px" src="{{asset('home/images/c3.jpg')}}"
                                    onerror="this.onerror=null;this.src='./assets/images/logos/default.png';"
                                    data-sizecode="a">
                            </div>
                        </li>
                        ...
                        <li>
                            <div><img style="width: 96px" src="{{asset('home/images/ltc.png')}}"
                                    onerror="this.onerror=null;this.src='./assets/images/logos/default.png';"
                                    data-sizecode="a">
                            </div>
                        </li>
                        ...
                        <li>
                            <div><img style="width: 96px" src="{{asset('home/images/eth.png')}}"
                                    onerror="this.onerror=null;this.src='./assets/images/logos/default.png';"
                                    data-sizecode="a">
                            </div>
                        </li>
                        ...
                        <li>
                            <div><img style="width: 96px" src="{{asset('home/images/pp.png')}}"
                                    onerror="this.onerror=null;this.src='./assets/images/logos/default.png';"
                                    data-sizecode="a">
                            </div>
                        </li>
                        ...
                        <li>
                            <div><img style="width: 96px" src="{{asset('home/images/bank-transfer.png')}}"
                                    onerror="this.onerror=null;this.src='./assets/images/logos/default.png';"
                                    data-sizecode="a">
                            </div>
                        </li>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="footer__text-about">
                            <div class="footer__logo">
                                <a href="{{route('home')}}"><img src="{{ asset('images/'.$settings->logo)}}" alt="" style="width:220px; transform: translateY(-30px)" alt=""></a>
                            </div>
